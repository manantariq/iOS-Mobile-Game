...
class AppDelegate: UIResponder, UIApplicationDelegate,UINavigationControllerDelegate,UIImagePickerControllerDelegate {
    ...
    var window: UIWindow?
    lazy var soundController = SoundController.sharedInstance
        
    
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        // Override point for customization after application launch.
        // Set default preferences if app's first run
        CoreDataController.shared.setAppSettings()
        return true
    }
    ...
    lazy var persistentContainer: NSPersistentContainer = {
         ...
         */
        let container = NSPersistentContainer(name: "MobileApp16")
